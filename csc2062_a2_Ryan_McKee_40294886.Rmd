...
```
In the above summary statistics presented in the table above there appears to already be clear differences in the mean standard deviation and medians between the majority of the letter and non letter features. Based on the values presented there seems to be a clear correlation between pixel number, rows with 1, rows with 3 pixels or greater and columns being having 3 pixels or greater having greater means.
